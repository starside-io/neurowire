...
- This repo is not a git repo by default and has no GitHub remote assumed. The `.github/workflows/news.yml` Pages workflow is one example scheduler; the generator (`neurowire-web` / `pnpm page`) runs from any cron or routine.
